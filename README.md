...
Generated from: https://api.apis.guru/v2/specs/azure.com/azsadmin-IpPool/2016-05-01/swagger.json<br/>
...
* `resourceGroupName` - _required_ - Name of the resource group.
* `location` - _required_ - Location of the resource.
* `ipPool` - _required_ - IP pool name.
* `api-version` - _required_ - Client API Version.
...
**flow**ground :- Telekom iPaaS / azure-com-azsadmin-ip-pool-connector<br/>
